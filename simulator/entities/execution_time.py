...
class ExecutionTime(BaseEntity):
    def __init__(
        ...
        post_prepare_inputs_barrier_time: float,
        ray_comm_time: float,
    ) -> None:
        ...
        self._rms_norm_time = rms_norm_time
        ...
        self._post_prepare_inputs_barrier_time = post_prepare_inputs_barrier_time
    ...
    def _get_cpu_overhead(self) -> float:
        return (
            ...
            + self._post_prepare_inputs_barrier_time
            + self._ray_comm_time
        )

    @property
    def num_blocks(self) -> int:
        return self._num_blocks_per_pipeline_stage
    ...
    @property
    def attention_prefill_kv_cache_prep_execution_time(self) -> float:
        return self._attention_prefill_kv_cache_prep_execution_time
    ...
    @property
    def attention_prefill_output_reshape_copy_execution_time(self) -> float:
        return self._attention_prefill_output_reshape_copy_execution_time
    ...
    @property
    def post_prepare_inputs_barrier_time(self) -> float:
        return self._post_prepare_inputs_barrier_time
    ...
    @property
    def rms_norm_time(self) -> float:
        return self._rms_norm_time
    ...
    def model_time(self) -> float:
        ...
        pipeline_stage_execution_time = (
            block_execution_time * self._num_blocks_per_pipeline_stage
        )
        # return in seconds
        return (
