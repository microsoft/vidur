...
class SplitwiseReplicaScheduler(BaseReplicaScheduler):
    def __init__(
        ...
        self._scheduler = self.get_replica_scheduler(config, replica, num_stages, execution_time_predictor)

    def get_replica_scheduler(self, config: Config, replica: Replica, num_stages: int, execution_time_predictor: BaseExecutionTimePredictor):
